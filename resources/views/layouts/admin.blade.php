    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white shadow-md p-6 space-y-6">
            ...
            <nav class="flex flex-col space-y-4 mt-6 text-green-700 font-semibold">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 hover:underline">
                    <i data-lucide="layout-dashboard" class="w-5 h-5"></i> Dashboard
                </a>
                <a href="{{ route('admin.rules.history') }}" class="flex items-center gap-2 hover:underline">
                    <i data-lucide="history" class="w-5 h-5"></i> Riwayat Perhitungan
                </a>
                <a href="{{ route('admin.rules.upload') }}" class="flex items-center gap-2 hover:underline">
                    <i data-lucide="file-up" class="w-5 h-5"></i> Perhitungan ID3 Rules Baru
                </a>
                <a href="{{ route('admin.profile') }}" class="flex items-center gap-2 hover:underline">
